<cfcomponent singleton="true">
	...
	<cffunction name="list" access="public" returntype="query" output="false">
		...
		<cfquery name="local.qry" datasource="#dsn.name#">
			SELECT
				T.*, TC.name as Category, TT.name as Type, CONCAT(P.fname, ' ', P.lname) as personName, BA.accountID
			FROM transactions T
				...
				LEFT JOIN bankAccounts BA ON T.bankAccountID = BA.ID
			WHERE 1 = 1
	...
	<cffunction name="new" access="public" returntype="void" output="false">
		...
		<cfargument name="bankAccountID" type="numeric" required="true">
		<cfargument name="personID" type="numeric" required="true">
		<cfargument name="description" type="string" required="true">
		<cfargument name="amount" type="string" required="true">

		<cfquery name="local.qry" datasource="#dsn.name#">
			INSERT INTO transactions( categoryID, bankAccountID, personID, description, amount )
			VALUES( #arguments.categoryID#, <cfqueryparam value="#arguments.bankAccountID#" cfsqltype="cf_sql_numeric" null="#(arguments.bankAccountID EQ 0)#">, #arguments.personID#, '#arguments.description#', '#arguments.amount#')
		</cfquery>
	</cffunction>
	...
	<cffunction name="update" access="public" returntype="void" output="false">
		...
		<cfquery name="local.qry" datasource="#dsn.name#">
			UPDATE transactions SET
				...
				bankAccountID = <cfqueryparam value="#arguments.bankAccountID#" cfsqltype="cf_sql_numeric" null="#(arguments.bankAccountID EQ 0)#">,
