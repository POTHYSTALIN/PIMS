...
component {
	...
	// Module Entry Point
	this.entryPoint			= "events";
	// Inherit entry point from parent, so this will be /api/events
	this.inheritEntryPoint  = true;
	// Model Namespace
	this.modelNamespace		= "events";
	// CF Mapping
	this.cfmapping			= "events";
	// Auto-map models
	...
	*/
	...
	function postModuleLoad( event, interceptData, buffer, rc, prc ) {
		...
		// binder.map( "eventsManagerService@sysinfo" ).to( "#moduleMapping#.models.inventoryItemPropertyDetails" );
	}
}
