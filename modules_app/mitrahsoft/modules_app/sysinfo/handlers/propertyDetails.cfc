component extends="coldbox.system.EventHandler" {
	...
	function addEdit( event, rc, prc ) {
		...
		prc.formAction = val( rc.id ) ? "mitrahsoft.sysinfo.prop-details.update" : "mitrahsoft.sysinfo.prop-details.add";
		...
		if( structKeyExists(rc, "submit") ) {
			...
			relocate(event = 'mitrahsoft.sysinfo.prop-details', persist = "msg,msgAction");
		}
