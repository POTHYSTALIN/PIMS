<cfoutput>
	<form action="#event.buildLink( lCase( prc.formAction ) )#" method="post">
		...
		<div class="form-group row">
			<label for="name" class="col-sm-2 col-form-label">Hardware</label>
			<div class="col-sm-10">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="checkbox" id="deleted" name="deleted" <cfif prc.item.deleted EQ 1>checked</cfif> value="1">
			</div>
		</div>
		<div class="form-group row">
