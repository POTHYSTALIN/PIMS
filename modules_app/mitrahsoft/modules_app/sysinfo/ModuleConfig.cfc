...
component {
	...
	function configure() {
		...
		router
			...
			.route( "item-details/delete/:id-numeric", "itemDetails.delete" )
			.route( "item-details/delete", "itemDetails.delete" )
			.route( "item-details/update/:id-numeric", "itemDetails.addEdit" )
			.route( "item-details/update", "itemDetails.addEdit" )
			.route( "item-details/edit/:id-numeric", "itemDetails.addEdit" )
			.route( "item-details/add", "itemDetails.addEdit" )
			.route( "item-details", "itemDetails.index" )
